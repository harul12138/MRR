...
class BookmarkViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func observeDatabase() {
        ...
        let container = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.mmr.nfinder")
    ...
    func index(item: Int) {
        ...
        let item = CSSearchableItem(uniqueIdentifier: "\(item)", domainIdentifier: "com.mmr", attributeSet: attributeSet)
...
extension BookmarkViewController: DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
    ...
    func title(forEmptyDataSet scrollView: UIScrollView) -> NSAttributedString? {
        let str = "No Articles Bookmarked YET"
